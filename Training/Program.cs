...
namespace Training
{
    class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.UseCommercetoolsApi(configuration, new List<string>{"Client", "StoreClient", "ImportApiClient" }, CreateDefaultTokenProvider);
        ...
        {
            var runningEx = args != null && args.Length > 0 ? args[0] : "04B"; //Task02A is the default exercise
