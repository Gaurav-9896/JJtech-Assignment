...
namespace Training
{
    public class Task03B : IExercise
    {
        ...
        private const string containerKey = "MyContainer";
        ...
        public async Task ExecuteAsync()
        {
            ...
            var Container = new ImportContainerDraft()
            {
                Key = containerKey,
            };

            var importContainer = await _importService.CreateImportContainer(Container);
