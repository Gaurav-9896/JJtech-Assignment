...
namespace Training.Services
{
    public class ImportService
    {
        ...
        {
            return await _importClient
                        .WithImportApi()
                        .WithProjectKeyValue(Settings.ProjectKey)
                        .ImportContainers()
        ...
        {
            var importContainerDraft = new ImportContainerDraft()
            {
        ...
        {    
            var result= await _importClient
                     .WithImportApi() 
                     .WithProjectKeyValue(Settings.ProjectKey)
                     .ImportOperations()
        ...
        {
            var productDrafts = GetProductDraftImportList(csvFile);
            var request = new ProductDraftImportRequest()
            {
